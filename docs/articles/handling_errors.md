...
Though, you can also detect syntax errors before the evaluation by using the <xref:NCalc.ExpressionBase`1.HasErrors(System.Threading.CancellationToken)> method.
