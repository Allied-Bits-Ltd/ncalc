...
public class NoStringTypeCoercionTests
{
    ...
    {
        var res = new Expression(expression, ExpressionOptions.NoStringTypeCoercion, CultureInfo.InvariantCulture).Evaluate(TestContext.Current.CancellationToken);
    ...
    {
        Assert.Equal(expected, new Expression(expression, ExpressionOptions.NoStringTypeCoercion).Evaluate(TestContext.Current.CancellationToken));
    }
