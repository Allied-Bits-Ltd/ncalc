...
public static class AsyncBuiltInFunctionHelper
{
    public static async ValueTask<object?> EvaluateAsync(string functionName, AsyncExpression[] arguments, AsyncExpressionContext context)
    {
        ...
        if (functionName.Equals("%") || functionName.Equals("PercentOf", comparison))
        {
            ...
            object? arg1 = await arguments[0].EvaluateAsync().ConfigureAwait(false);
            if (arg1 == null)
                return null;
            object? arg2 = await arguments[1].EvaluateAsync().ConfigureAwait(false);
            if (arg2 == null)
                return null;
        ...
        if (functionName.Equals("IEEERemainder", comparison))
        {
            ...
            return MathHelper.IEEERemainder(await arguments[0].EvaluateAsync().ConfigureAwait(false), await arguments[1].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Ln", comparison))
        {
            if (arguments.Length != 1)
                throw new NCalcEvaluationException("Ln() takes exactly 1 argument");
            return MathHelper.Ln(await arguments[0].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Log", comparison))
        {
            if (arguments.Length != 2)
                throw new NCalcEvaluationException("Log() takes exactly 2 arguments");
            return MathHelper.Log(await arguments[0].EvaluateAsync().ConfigureAwait(false), await arguments[1].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Log10", comparison))
        {
            if (arguments.Length != 1)
                throw new NCalcEvaluationException("Log10() takes exactly 1 argument");
            return MathHelper.Log10(await arguments[0].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Pow", comparison))
        {
            if (arguments.Length != 2)
                throw new NCalcEvaluationException("Pow() takes exactly 2 arguments");
            return MathHelper.Pow(await arguments[0].EvaluateAsync().ConfigureAwait(false), await arguments[1].EvaluateAsync().ConfigureAwait(false), true, context);
        }
        if (functionName.Equals("Round", comparison))
        {
            ...
            return MathHelper.Round(await arguments[0].EvaluateAsync().ConfigureAwait(false), await arguments[1].EvaluateAsync().ConfigureAwait(false), rounding, context);
        }
        if (functionName.Equals("Sign", comparison))
        {
            if (arguments.Length != 1)
                throw new NCalcEvaluationException("Sign() takes exactly 1 argument");
            return MathHelper.Sign(await arguments[0].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Sin", comparison))
        {
            if (arguments.Length != 1)
                throw new NCalcEvaluationException("Sin() takes exactly 1 argument");
            return MathHelper.Sin(await arguments[0].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Sqrt", comparison))
        {
            if (arguments.Length != 1)
                throw new NCalcEvaluationException("Sqrt() takes exactly 1 argument");
            return MathHelper.Sqrt(await arguments[0].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Tan", comparison))
        {
            if (arguments.Length != 1)
                throw new NCalcEvaluationException("Tan() takes exactly 1 argument");
            return MathHelper.Tan(await arguments[0].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Truncate", comparison))
        {
            if (arguments.Length != 1)
                throw new NCalcEvaluationException("Truncate() takes exactly 1 argument");
            return MathHelper.Truncate(await arguments[0].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Max", comparison))
        {
            if (arguments.Length != 2)
                throw new NCalcEvaluationException("Max() takes exactly 2 arguments");
            return MathHelper.Max(await arguments[0].EvaluateAsync().ConfigureAwait(false), await arguments[1].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("Min", comparison))
        {
            if (arguments.Length != 2)
                throw new NCalcEvaluationException("Min() takes exactly 2 arguments");
            return MathHelper.Min(await arguments[0].EvaluateAsync().ConfigureAwait(false), await arguments[1].EvaluateAsync().ConfigureAwait(false), context);
        }
        if (functionName.Equals("ifs", comparison))
        {
            ...
            foreach (var argument in arguments.Where((_, i) => i % 2 == 0))
            {
                ...
                if (tf)
                    return await arguments[index + 1].EvaluateAsync().ConfigureAwait(false);
            }
        ...
        if (functionName.Equals("if", comparison))
        {
            ...
            var cond = Convert.ToBoolean(await arguments[0].EvaluateAsync().ConfigureAwait(false), context.CultureInfo);
            return cond ? await arguments[1].EvaluateAsync().ConfigureAwait(false) : await arguments[2].EvaluateAsync().ConfigureAwait(false);
        }
        if (functionName.Equals("in", comparison))
        {
            if (arguments.Length < 2)
                throw new NCalcEvaluationException("in() takes at least 2 arguments");
            var parameter = await arguments[0].EvaluateAsync().ConfigureAwait(false);
            var evaluation = false;
            for (var i = 1; i < arguments.Length; i++)
            {
                if (TypeHelper.CompareUsingMostPreciseType(parameter, await arguments[i].EvaluateAsync().ConfigureAwait(false), context) != 0) continue;
                evaluation = true;
                break;
            }
